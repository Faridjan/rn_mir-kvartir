...
// Select sortBy
export const sortBySelector = createSelector(product, (data) => data.get('sortBy'))

// Select filterBy
export const filterBySelector = createSelector(product, (data) => data.get('filterBy'))

// Select attribute
export const attributeSelector = createSelector(product, (data) => data.get('attribute'))
