...
export const loginWithGoogle = (user) => request.post('/rnlab-app-control/v1/google', user)

export const loginWithApple = (data) => request.post('/rnlab-app-control/v1/apple', data)

export const registerWithEmail = (data) => request.post('/rnlab-app-control/v1/register', data)
...
export const getCustomer = (user_id) => request.get(`/wc/v3/customers/${user_id}`)

export const logout = () => request.get('users/logout')
export const signOut = () => request.get('users/logout')
